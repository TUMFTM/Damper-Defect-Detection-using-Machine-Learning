function testData = analyzeNoveltyClassifier(varargin)
    ...
    if find(strcmp(varargin,'pathResultFolder'))
        ...
        pathResultFolder = {'test','dataFull','C:\Work\Fahrwerkdiagnose\Datenanalyse\BMW\MachineLearning\ManuelleFeatures\NoveltyDetection\2020_03_31_15h_59_try_manFeat\result\test';...
            'val','dataFull','C:\Work\Fahrwerkdiagnose\Datenanalyse\BMW\MachineLearning\ManuelleFeatures\NoveltyDetection\2020_03_31_15h_59_try_manFeat\result\val'};
    end
    ...
    for cntPath = 1 : size(pathResultFolder,1)
        ...
        for cntCV = 0 : numCV-1
            structTest{cntCV+1} = importNoveltyResult([tmpPath,'\cv',num2str(cntCV)], tmpOrigData, '');
        end

% Script for exporting data from a Label-Excel to a csv which can be read
% by Python scripts
...
% filename = 'Label_DD_ReiterEngineering.xlsx';
filename = 'Label_DD2_kurz.xlsx';
